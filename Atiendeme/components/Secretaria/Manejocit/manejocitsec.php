...
<body>
    <div class="d-flex" id="content-wrapper">
        ...
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="menu">
                ...
                <a href="manejocitsec.php" class="d-block text-light p-3 border-0 active-menu-option">Manejo cita</a>
    ...
    <script src="js/menejocitsec.js"></script>
