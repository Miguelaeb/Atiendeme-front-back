...
<head>
    ...
    <title>Atiendeme - Secretaria dashboard</title>
</head>
    ...
    <div class="d-flex" id="content-wrapper">
        ...
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="menu">
                ...
                <a href="manejocitsec.php" class="d-block text-light p-3 border-0">Manejo cita</a>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 d-flex stat my-3">
                                        <div class="mx-auto">
                                            <a type="button" class="btn btn-outline-info">Hacer cita</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 d-flex stat my-3">
                                        <div class="mx-auto">
                                            <a href="manejocitsec.php" type="button" class="btn btn-outline-info">Manejo de cita</a>
                                        </div>
                                    </div>
                                    
                                    <div class="col-lg-3 col-md-6 d-flex stat my-3">
                                    <div class="mx-auto">
                                            <a href="CitasPendientes.php" type="button" class="btn btn-outline-info">Citas pendientes</a>
                                        </div>
                                    </div>
