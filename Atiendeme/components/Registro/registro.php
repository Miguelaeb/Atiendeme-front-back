...
<head>
    ...
    <!-- Title Page-->
    <title>Atiendeme - Registro</title>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="controller/registro.php">
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Nombres" name="name" required="">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Apellidos" name="lastname">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3 js-datepicker" type="text" placeholder="Cumpleaños" name="birthday">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Telefono" name="phone">
                        </div>
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit" name="btnRegister">Registrarse</button>
                        </div>
                    </form>
                </div>
            </div>
